...
<body>
    ...
    <header class="mainColor">
         <svg xmlns="http://www.w3.org/2000/svg" width="50" onclick="show()" class="glyphicon glyphicon-user out" height="16" fill="currentColor" class="bi bi-person-fill" viewBox="0 0 16 16">
    ...
    <main>
        ...
        <div id="window">
           <p style="color:#1A5058;">
               ...
               <?php  
    		    echo "<br>".$rows['firstName']." ".$rows['lastName']."<br>"."0".$rows['phone']."<br>".$rows['email']."<br>".$rows['role'];
                ?> 
                <br>
                <br>
        ...
        <!--open a new malfunction-->
        <div class="other">
            <a href="new_malfunction.html"><img src="photos/malfunctions.png" alt="malfunction" class="func"></a>
            <p>malfunctions</p>
        </div>
...
<button onclick="hide1()" class="xx">X</button>
    ...
    onCancel: function (data) {
        ...
        <!--watch contract and furniture list-->
        <div class="other">
            <a href="watchFLst.php"><img src="photos/contract.png" alt="contract" class="func"></a>
            <p>contract</p>
        </div>
    </main>
